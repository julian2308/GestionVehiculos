...
public class ClientesController implements Initializable {
    ...
    private void irCrear(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/vista/clientesNuevo.fxml"));
            Parent root = loader.load();
            ClientesNuevoController controller = loader.getController();
    ...
    private void irBuscarTodos(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/vista/todosClientes.fxml"));
            Parent root = loader.load();
            TodosClientesController controller = loader.getController();
            Scene scene = new Scene(root);
            Stage stage = new Stage();
            //stage.initModality(Modality.APPLICATION_MODAL);
            stage.setScene(scene);
    ...
    private void buscar(ActionEvent event) {
        ...
        if (gestor.existeCedula(cedula)) {
            ...
            Cliente miCliente = gestor.devolverCliente(cedula);
            try {
                ...
                controlador.clienteExistente(miCliente);
